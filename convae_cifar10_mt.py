...
def build_convae_model():
    ...
    x = Reshape((8,8,64))(x_encode)
    x = UpSampling2D((2,2))(x)
    x = Conv2DTranspose(64, (4, 4), strides=(1, 1), padding='same', activation='relu')(x)
    x = Conv2DTranspose(64, (4, 4), strides=(1, 1), padding='same', activation='relu')(x)
    x = Conv2DTranspose(3, (4, 4), strides=(2, 2), padding='same', activation='relu')(x)
